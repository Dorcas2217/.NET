...
while (!exit)
{
    ...
    Console.WriteLine("5 - Afficher les étudiants par section triée par ordre de résultat");
    ...
    switch (userInput)
    {
        ...
        case "5":
            Console.WriteLine("Liste des étudiants par sections ");
            var studentsBySection = unitOfWorkSchool.StudentRepository.GetAll()
                                    .OrderByDescending(student => student.YearResult)
                                    .GroupBy(student => student.Section)
                                    .ToList();
